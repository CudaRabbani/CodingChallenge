...
For ubuntu:
	...
	3. in terminal type: "bash run.sh"
	4. Input the accurate gender and age.

For windows:
	1. Go the downloaded project directory.
	2. From the cmd type: "javac *.java"
	3. After successful compilation type: "java Driver"
